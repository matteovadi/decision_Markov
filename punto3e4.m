...
[x,S,R,g1,g2,alpha,epsilon,delta,N_w,p1,p2,pr] = problem_setup_3();
...
title('Policy ottimale \mu: non confezionare (celeste), 2 pezzi da C1 (senape), 2 pezzi da C2 (turchese), 1 pezzo da C1 e 1 da C2 (giallo) ')
axis(0.5+[0 n 0 m]);
