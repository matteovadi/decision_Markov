...
function [x,S,R,g1,g2,alpha,epsilon,delta,N_w,p1,p2,pr] = problem_setup_6b()

% Costi unitari: 
R = 10; % costo per ogni pezzo scartato
g1 = 5; % costo per ogni pezzo all'interno del cestello 1
...
S = 9; % capacità massima di ogni cestello
...
pr = [p_C1(1,1)*p_C2(1,1); 
      p_C1(1,2)*p_C2(1,1); 
      p_C1(1,1)*p_C2(1,2); 
      p_C1(1,2)*p_C2(1,2)]; % riempimenti indipendnenti, probabilità dell'intersezione = prodotto delle probabilità 
